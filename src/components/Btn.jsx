...
export default function Btn({ variant = 'sec', icon, label, href, target, rel, onClick, className = '' }) {
  ...
  if (href) {
    return (
      <a href={href} target={target} rel={rel} style={baseStyle} className={className}>
        {inner}
      </a>
    )
  }
