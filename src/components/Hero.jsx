...
const ICON_FILE = 'https://www.figma.com/api/mcp/asset/68e38d59-ab16-47ea-af1a-a5a25c54fa7a'
const ICON_GITHUB = 'https://www.figma.com/api/mcp/asset/4af55f1b-5ac2-49ef-a612-d807baaa2b35'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            ...
            style={{ fontSize: 'clamp(2.5rem, 6.67vw, 6rem)', letterSpacing: '-1.44px', lineHeight: '80.64px', padding: '10px' }}
          >
            소음
          </span>
          <span
            className="font-sans font-extralight text-near-black"
            style={{ fontSize: 'clamp(2rem, 5vw, 4.5rem)', letterSpacing: '-1.44px', lineHeight: '80.64px', padding: '0 8px' }}
          >
            을
          </span>
          <span
          ...
          <span
            className="font-sans font-extralight text-near-black"
            style={{ fontSize: 'clamp(2rem, 5vw, 4.5rem)', letterSpacing: '-1.44px', lineHeight: '80.64px', paddingLeft: '8px' }}
          >
            으로
          </span>
        </div>
        ...
        <p
          ...
          style={{ fontSize: 'clamp(2rem, 5vw, 4.5rem)', letterSpacing: '-1.44px', lineHeight: '80.64px' }}
        >
          경험조율사 안건입니다
        </p>
      </div>
      ...
      <div
        ...
        style={{ top: '246px', width: 'clamp(280px, 38.6vw, 556px)', height: 'clamp(390px, 54.2vw, 781px)' }}
      >
        <img
          src={bannerImg}
          alt="안건"
